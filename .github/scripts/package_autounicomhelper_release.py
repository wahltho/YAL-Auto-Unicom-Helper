#!/usr/bin/env python3
"""Build and verify GitHub release assets for YAL Auto-Unicom Helper."""
...
PACKAGE_ROOT = "YAL_AutoUnicomHelper"
PACKAGE_ID = "wahltho.yal-autounicomhelper"
REPOSITORY = "https://github.com/wahltho/YAL-Auto-Unicom-Helper"
INSTALL_SCOPE = "xPlaneInstallation"
TARGET_PATH = "Resources/plugins/YAL_AutoUnicomHelper"
ARCHIVE_PREFIX = "YAL-AutoUnicomHelper"
...
PACKAGE_MAP = (
    ...
    ("LICENSE", "LICENSE"),
    ("README.md", "README.md"),
    ("YAL_AutoUnicomHelper.prf.example", "YAL_AutoUnicomHelper.prf.example"),
)
...
def validate_versions(root: Path, channel: str, version: str) -> None:
    ...
    code_version = extract_regex(
        root / "src/YAL_autounicomhelper.cpp",
    ...
    expected = {
        "src/YAL_autounicomhelper.cpp": code_version,
...
def build_release_assets(root: Path, output_dir: Path, channel: str, version: str) -> tuple[Path, Path, Path, Path]:
    ...
    with manifest_path.open("w", encoding="utf-8", newline="\n") as manifest:
        manifest.write(f"YAL Auto-Unicom Helper release package {version}\n")
